...
import { Bell, Plus, MessageSquare, LogOut, User, DollarSign, MapPin, Star, Search, X, Instagram, Menu, Headphones, ChevronUp, Sparkles, ArrowRight, RefreshCw, Share2, Copy, Check, TrendingUp, TrendingDown, Minus, Flag, Ban } from "lucide-react";
...
export default function Dashboard({ user, logout, unreadCount = 0, setUser }) {
  ...
  const fetchData = async () => {
    ...
    // Fetch exchange rates separately (no auth required)
    try {
                        ...
                        <div className="flex flex-col sm:flex-row items-start justify-between gap-3 sm:gap-4">
                          ...
                          <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-between gap-2 w-full sm:w-auto">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              {/* ALWAYS SHOW REPORT BUTTON FOR TESTING */}
                              <Button
                                size="sm"
                                variant="ghost"
