...
export const CURRENCIES = [
  "USD", "EUR", "GBP", "TRY", "AED", "SAR", "QAR", "KWD", "OMR", "BHD",
  "CNY", "JPY", "INR", "PKR", "IDR", "THB", "PHP", "KRW", "MYR", "SGD",
  "HKD", "VND", "CHF", "SEK", "NOK", "DKK", "PLN", "CZK", "HUF", "RON",
  "BGN", "RUB", "UAH", "CAD", "MXN", "BRL", "ARS", "COP", "CLP", "PEN",
  "AUD", "NZD", "ZAR", "EGP", "NGN", "KES", "MAD", "TND", "DZD", "ILS",
  "JOD", "LBP", "IQD", "IRR", "AFN", "BDT", "LKR", "NPR", "MMK", "KHR"
];
